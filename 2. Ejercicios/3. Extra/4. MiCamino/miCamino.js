...
console.log("-------------------------------------------------------------------------");
console.log("RESULTADO DE LOS EJERCICIOS");
console.log("-------------------------------------------------------------------------");
...
for (let i = 0; i < miCamino.material.length; i++) {
  ...
  if (i === 0) {
    ...
    console.log("Lo segundo que debo llevar es " + material.nombre + " y es " + material.descripcion);
  } else if (i === 2) {
    console.log("Lo tercero que debo llevar es " + material.nombre + " y es " + material.descripcion);
  } else if (i === 3) {
    console.log("Y por último debo llevar la " + material.nombre + " y es " + material.descripcion);
  }
}
...
const cimas = miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV;
const mensajeFinal = [];

for (i = 0; i < cimas.length; i++) {
  const cima = cimas[i];

  if (typeof cima === "string") {
    mensajeFinal.push(cima);
  }
}
...
let mensajeCima = miCamino.subiendoAlEverest[0][0].campoBase[0].campoI.campoII.campoIII.campoIV[8].cima;

console.log(mensajeCima);
